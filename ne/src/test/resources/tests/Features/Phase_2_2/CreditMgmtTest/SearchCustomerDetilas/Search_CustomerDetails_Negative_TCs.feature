@wlntest
Feature: CreditManagement - Search CreditProfile
  ...
  @SearchCreditProfile_Negative_TC @SearchCreditProfile @Regression_Suite @Regression_Suite_CreditProfile_TCs @WLN @WLN_SearchCreditProfile 
 ...
 @SearchCreditProfile_Negative_TC @SearchCreditProfile @Regression_Suite @Regression_Suite_CreditProfile_TCs @WLN @WLN_SearchCreditProfie
  Scenario Outline: Search Customer : Negative <testScenario>
   ...
   * def headerData = {env: '#(envName)' }
    ...
    * print 'SERVICE_VERSION: ' + SERVICE_VERSION
    ...
    And match  response.message == <message>
     ...
     @SearchCreditProfile_Party   @Regression_Suite @Regression_Suite_CreditProfile_TCs @WLN @WLN_SearchCreditProfie
  Scenario Outline: Search Customer : Negative <testScenario>
