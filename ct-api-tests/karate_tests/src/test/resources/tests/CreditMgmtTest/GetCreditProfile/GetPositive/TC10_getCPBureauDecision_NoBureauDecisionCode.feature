...
#    * set testData.Id = '10628686'
    ...
    * print "Validate Get Response value"
    ...
    #Then match $.response.creditProfile[0].telusCharacteristic.bureauDecisionMessage == null
    ...
    * print 'READDB_SYNC_STATUS TABLE Result: ' + ReadDBSynResult
    ...
    Examples:
      ...
      | TC10_getCPBureauDecision_NoBureauDecisionCode  | 6000 | 'Social Insurance Number' | '1990-02-01' | 'Individual' |     470 | ''    | 'L'     | 'CLP'  | 'CCW'   | 'CAN'   | 'AB'     | 'postalAddress' | 123456783 | 'SIN'   | UNVERIFIED | CITADEL            |   400 | 'Toronto' | 2019-01-10T16:51:22.620Z |  ''