...
#    * set testData.Id = '11221264'
    ...
    * print 'READDB_SYNC_STATUS TABLE Result: ' + ReadDBSynResult
    ...
    Examples:
      ...
      | TC5_getCPCCParams_IdTypDL_CCLsK_prgmDCL  | 6000 | 'Drivers License' | '1990-02-01' | 'Individual' |     470 | 'E29'    | 'K'     | 'DCL'  | 'SEW'   | 'CAN'   | 'AB'     | 'postalAddress' | DL12345678 | 'DL'   | UNVERIFIED | CITADEL            |   400 | 'Toronto' | 2019-01-10T16:51:22.620Z |
