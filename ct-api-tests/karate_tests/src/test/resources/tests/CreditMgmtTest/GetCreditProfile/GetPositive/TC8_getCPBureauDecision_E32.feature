...
#    * set testData.Id = '10628686'
    ...
    * print "Validate Get Response value"
    ...
    Then match $.response.creditProfile[0].telusCharacteristic.bureauDecisionMessage == <bureauDCMessage>
    ...
    * print 'READDB_SYNC_STATUS TABLE Result: ' + ReadDBSynResult
    ...
    Examples:
      | testScenario                | Id   | idTyp             | DOB          | ReffTyp      | crdtSCR | bureauDC | crdtCls | CPrgNM | WarngCd | Country | province | medTyp          | IdNum      | id_typ | warStsCd   | warCd              | rRtng | city      | Wdate                    |  bureauDCMessage
      | TC8_getCPBureauDecision_E32.feature  | 6000 | 'Social Insurance Number' | '1990-02-01' | 'Individual' |     470 | 'E32'    | 'L'     | 'CLP'  | 'CCW'   | 'CAN'   | 'AB'     | 'postalAddress' | 123456783 | 'SIN'   | UNVERIFIED | CITADEL            |   400 | 'Toronto' | 2019-01-10T16:51:22.620Z |  'E32 - A $200 deposit is required. Or offer Prepaid. Review Bureau Warning'