...
#    * set testData.Id = '10628686'
    ...
    * print 'READDB_SYNC_STATUS TABLE Result: ' + ReadDBSynResult
    ...
    Examples:
      ...
      | TC7_getCPWarningHistory_WarningCodeCCW  | 6000 | 'Social Insurance Number' | '1990-02-01' | 'Individual' |     470 | 'E29'    | 'L'     | 'CLP'  | 'CCW'   | 'CAN'   | 'AB'     | 'postalAddress' | 123456783 | 'SIN'   | UNVERIFIED | CITADEL            |   400 | 'Toronto' | 2019-01-10T16:51:22.620Z |
