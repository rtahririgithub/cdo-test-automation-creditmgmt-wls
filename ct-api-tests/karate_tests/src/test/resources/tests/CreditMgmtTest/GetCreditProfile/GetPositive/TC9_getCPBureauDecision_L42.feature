...
#    * set testData.Id = '10628686'
    ...
    * print 'READDB_SYNC_STATUS TABLE Result: ' + ReadDBSynResult
    ...
    Examples:
      ...
      | TC9_getCPBureauDecision_L42  | 6000 | 'Social Insurance Number' | '1990-02-01' | 'Individual' |     470 | 'L42'    | 'L'     | 'CLP'  | 'CCW'   | 'CAN'   | 'AB'     | 'postalAddress' | 123456783 | 'SIN'   | UNVERIFIED | CITADEL            |   400 | 'Toronto' | 2019-01-10T16:51:22.620Z |  'L42 - A $200 deposit is required. Or offer Prepaid Review Bureau Warning'
