...
#    * set testData.Id = '21032998'
    ...
    * print 'READDB_SYNC_STATUS TABLE Result: ' + ReadDBSynResult
    ...
    Examples:
      ...
      | TC4_getCPOrganizational_IdTypDL | 3042 | 'Drivers License' | '1990-02-01' | 'Organization' |       500 | 'E29'    | 'B'       | 'NDP'       | 'CCW'   | 'CAN'   | 'QC'     | 'postalAddress' | 843785112 | 'DL'  | UNVERIFIED | CITADEL | 'L' | 470 | 'NDP' | 400        | 'Vancouver'
