...
Feature: CreditManagement - CreateCreditProfile
  ...
  Scenario Outline: CreateCreditProfile -NegativeTC with <testScenario>
    ...
    * set testData.payloadName = 'MissingEngagedPartyObj_payload.json'
    * print testData
    ...
    * def response =  call read(PATH_SERVICES_CREATECPROFILE+'CreateCreditProfile_Operation.feature') testData
    ...
    Examples: 
      ...
      | Missing EngagedPartyObj | 3009 | 'Social Insurance Number' | '1990-02-01' | 'Individual' |       600 | 'E29'    | 'C'       | 'DEP'       | 'BCW'   | 'CAN'   | 'AB'     | 'postalAddress' | '12345678' | 'Vancouver' |       400 | '1108' | 'Engaged Party is required' |
