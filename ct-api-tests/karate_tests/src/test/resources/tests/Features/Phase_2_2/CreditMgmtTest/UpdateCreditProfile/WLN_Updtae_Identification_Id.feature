...
Feature: CreditManagement - Update_CreditProfile
   ...
   * def testDataSpec = read('Update_identification_id_and_identification_type_TestData.json')
    ...
    * print "CustomerID : " + CustomerID
     ...
     * set testData.credit_profile_id = credit_profile_id
     ...
     And def contactMediumID = $.response.relatedParty[0].engagedParty.contactMedium[0].id
    * set testData.contactMediumID = contactMediumID
    * print testData
    * print testData
    #
    ...
    * set testData.payloadUpdate = 'WLN_Update_identification_id_and_identification_type_payload.json'
    ...
    * print "Validate Get Response value"
    ...
    Then match $.response.relatedParty[0].engagedParty.birthDate == testData.UpdtaeDOB
    Then match $.response.relatedParty[0].engagedParty.contactMedium[0].mediumType == testData.UpdatemedTyp
    Then match $.response.relatedParty[0].engagedParty.contactMedium[0].characteristic.country == testData.UpdateCountry
    Then match $.response.relatedParty[0].engagedParty.contactMedium[0].characteristic.city == testData.Updatecity
    Then match $.response.relatedParty[0].engagedParty.contactMedium[0].characteristic.stateOrProvince == testData.provinceUpdate
    ...
    Then match $.response.relatedParty[0].engagedParty.individualIdentification[0].identificationId == testData.UpdateIdNum
...
#Assertion data in INDIVIDUAL TABLE
    ...
    * print 'PARTY_CONTACT_MEDIUM TABLE Result: ' + parContMedResult
    Then match parContMedResult[0].medium_type == testData.UpdatemedTyp
    ...
    * string partyCMStartTS = parContMedResult[0].valid_start_ts
    ...
    Examples: 
      | testScenario                                                    | data                                      |
      |Update Existing identification id number                         | 'Update_Existing_identification_id_number'  |
